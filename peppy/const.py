...
SAMPLE_MODIFIERS = \
    [CONSTANT_KEY, IMPLIED_KEY, DERIVED_KEY, DUPLICATED_KEY, REMOVE_KEY]
PROJECT_MODIFIERS = [CFG_IMPORTS_KEY, AMENDMENTS_KEY]
PROJECT_CONSTANTS = [
    "CONSTANT_KEY", "DERIVED_SOURCES_KEY", "DERIVED_KEY", "SAMPLE_MODS_KEY",
    "IMPLIED_KEY", "METADATA_KEY", "NAME_TABLE_ATTR", "OUTDIR_KEY",
    "CONFIG_FILE_KEY", "CONFIG_KEY", "NAME_KEY", "REMOVE_KEY",
    "AMENDMENTS_KEY", "PROJECT_TYPENAME", "SAMPLE_MODS_KEY",
...
SAMPLE_CONSTANTS = [
    ...
    "SUBSAMPLE_NAME_ATTR", "INPUTS_ATTR_NAME", "REQ_INPUTS_ATTR_NAME",
    "SAMPLE_YAML_FILE_KEY", "SAMPLE_YAML_EXT", "SAMPLE_MODIFIERS"]
